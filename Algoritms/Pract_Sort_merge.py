...
print("Задание 2")
queue = Queue()
queue.enqueue("Проснуться")
queue.enqueue("Потянуться")
queue.enqueue("Приготовить кофе")
queue.enqueue("Выпить кофе")
queue.enqueue("Одеться")
queue.enqueue("Уйти на работу")
print(queue.peek(),time(8,00,00))
queue.dequeue()
print(queue.peek(),time(8,00,20))
queue.dequeue()
print(queue.peek(),time(8,15,25))
queue.dequeue()
print(queue.peek(),time(8,25,00))
queue.dequeue()
print(queue.peek(),time(8,45,00))
queue.dequeue()
print(queue.peek(),time(9,10,00))
queue.dequeue()
# Задание 3
print("Задание 3")
def merge_sort(arr):
...
arr1 = arr
time_merge_sort = timeit.timeit(lambda: merge_sort, number=1000)
merge_sort(arr)
time_bubble_sort = timeit.timeit(lambda: bubble_sort, number=1000)
bubble_sort(arr1)

print("Время сортировки слиянием 10 элементов ", time_merge_sort)
print("Время сортировки пузырьком 10 элементов ", time_bubble_sort)
print("")
...
time_bubble_sort = timeit.timeit(lambda: bubble_sort, number=1000)
bubble_sort(arr1)
print("Время сортировки слиянием 100 элементов ", time_merge_sort)
print("Время сортировки пузырьком 100 элементов ", time_bubble_sort)
print("")
...
time_bubble_sort = timeit.timeit(lambda: bubble_sort, number=1000)
bubble_sort(arr1)
print("Время сортировки слиянием 1000 элементов ", time_merge_sort)
print("Время сортировки пузырьком 1000 элементов ", time_bubble_sort)